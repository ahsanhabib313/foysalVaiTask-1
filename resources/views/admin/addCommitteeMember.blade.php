        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="jumbotron bg-light text-dark font-weight-bold mt-2 mb-5">
                    <h2 class="text-center ">Add Committee Member </h2>
                        <form action="{{route('committeeMember.store')}}" method="POST" enctype="multipart/form-data" >
                            @csrf
                            <div class="form-group">
                                <label for="exampleInputEmail1"> Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Enter member name" value="{{ old('name') }}">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="designation" class="form-control" placeholder="Enter member designation" value="{{ old('designation') }}">
